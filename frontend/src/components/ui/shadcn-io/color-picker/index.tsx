...
export type InputColoPickerProps = {
	onChange?: (value: string) => void;
	className?: string;
};

export const InputColoPicker = ({
	onChange,
	className
}: InputColoPickerProps) => {
	const { hue, saturation, lightness, alpha, setHue, setSaturation, setLightness, setAlpha } = useColorPicker();
	const color = Color.hsl(hue, saturation, lightness, alpha / 100);
