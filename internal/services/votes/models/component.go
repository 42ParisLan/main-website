...
type UpdateComponent struct {
	Name        string `json:"name" example:"Network" description:"The name of the component" validate:"min=3"`
	Description string `json:"description" example:"Network infrastructure and connectivity" description:"The description of the component" validate:"min=3"`
