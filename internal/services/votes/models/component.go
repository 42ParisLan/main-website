...
type CreateComponent struct {
	...
	Image       huma.FormFile `form:"image" contentType:"iamge/*" description:"The uploaded image file" required:"true"`
}

type UpdateComponent struct { 	
	Name        *string                `form:"name" example:"Network" description:"The name of the component"  validate:"min=3"`
	Description *string                `form:"description" example:"Network infrastructure and connectivity" description:"The description of the component"  validate:"min=3"`
	Color       *string                `form:"color" example:"#FF5733" description:"The color of the component"`
	Image       *huma.FormFile `form:"image" contentType:"iamge/*" description:"The uploaded image file"`
}
