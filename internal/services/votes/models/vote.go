...
type UpdateVote struct {
	Title       string    `json:"title" example:"Best Programming Language 2025" description:"The title of the vote" validate:"min=3"`
	Description string    `json:"description" example:"Vote for your favorite language!" description:"The description of the vote" validate:"min=3"`
