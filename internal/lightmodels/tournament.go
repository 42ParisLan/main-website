...
type LightTournament struct {
	...
	Results             interface{} `json:"results,omitempty" description:"Tournament results in JSON format"`
...
func NewLightTournamentFromEnt(entTournament *ent.Tournament) *LightTournament {
	...
	return &LightTournament{
		...
		TeamStructure:       entTournament.TeamStructure,
