...
func (_c *NotificationCreate) SetHref(v string) *NotificationCreate {
	_c.mutation.SetHref(v)
	return _c
}

// SetNillableHref sets the "href" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableHref(v *string) *NotificationCreate {
	if v != nil {
		_c.SetHref(*v)
	}
	return _c
...
func (_c *NotificationCreate) SetUserID(id int) *NotificationCreate {
...
func (_c *NotificationCreate) createSpec() (*Notification, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Href(); ok {
