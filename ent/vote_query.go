...
func (_q *VoteQuery) QueryComponents() *ComponentQuery {
...
func (_q *VoteQuery) WithComponents(opts ...func(*ComponentQuery)) *VoteQuery {
	query := (&ComponentClient{config: _q.config}).Query()
...
func (_q *VoteQuery) loadComponents(ctx context.Context, query *ComponentQuery, nodes []*Vote, init func(*Vote), assign func(*Vote, *Component)) error {
	...
	query.Where(predicate.Component(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(vote.ComponentsColumn), fks...))
	}))
