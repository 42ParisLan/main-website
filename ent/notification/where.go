...
func Href(v string) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldHref, v))
}
...
func HrefEQ(v string) predicate.Notification {
	return predicate.Notification(sql.FieldEQ(FieldHref, v))
}

// HrefNEQ applies the NEQ predicate on the "href" field.
func HrefNEQ(v string) predicate.Notification {
	return predicate.Notification(sql.FieldNEQ(FieldHref, v))
}

// HrefIn applies the In predicate on the "href" field.
func HrefIn(vs ...string) predicate.Notification {
	return predicate.Notification(sql.FieldIn(FieldHref, vs...))
}

// HrefNotIn applies the NotIn predicate on the "href" field.
func HrefNotIn(vs ...string) predicate.Notification {
	return predicate.Notification(sql.FieldNotIn(FieldHref, vs...))
}

// HrefGT applies the GT predicate on the "href" field.
func HrefGT(v string) predicate.Notification {
	return predicate.Notification(sql.FieldGT(FieldHref, v))
}

// HrefGTE applies the GTE predicate on the "href" field.
func HrefGTE(v string) predicate.Notification {
	return predicate.Notification(sql.FieldGTE(FieldHref, v))
}

// HrefLT applies the LT predicate on the "href" field.
func HrefLT(v string) predicate.Notification {
	return predicate.Notification(sql.FieldLT(FieldHref, v))
}

// HrefLTE applies the LTE predicate on the "href" field.
func HrefLTE(v string) predicate.Notification {
	return predicate.Notification(sql.FieldLTE(FieldHref, v))
}

// HrefContains applies the Contains predicate on the "href" field.
func HrefContains(v string) predicate.Notification {
	return predicate.Notification(sql.FieldContains(FieldHref, v))
}

// HrefHasPrefix applies the HasPrefix predicate on the "href" field.
func HrefHasPrefix(v string) predicate.Notification {
	return predicate.Notification(sql.FieldHasPrefix(FieldHref, v))
}

// HrefHasSuffix applies the HasSuffix predicate on the "href" field.
func HrefHasSuffix(v string) predicate.Notification {
	return predicate.Notification(sql.FieldHasSuffix(FieldHref, v))
}

// HrefIsNil applies the IsNil predicate on the "href" field.
func HrefIsNil() predicate.Notification {
	return predicate.Notification(sql.FieldIsNull(FieldHref))
}

// HrefNotNil applies the NotNil predicate on the "href" field.
func HrefNotNil() predicate.Notification {
	return predicate.Notification(sql.FieldNotNull(FieldHref))
}

// HrefEqualFold applies the EqualFold predicate on the "href" field.
func HrefEqualFold(v string) predicate.Notification {
	return predicate.Notification(sql.FieldEqualFold(FieldHref, v))
}

// HrefContainsFold applies the ContainsFold predicate on the "href" field.
func HrefContainsFold(v string) predicate.Notification {
	return predicate.Notification(sql.FieldContainsFold(FieldHref, v))
}
