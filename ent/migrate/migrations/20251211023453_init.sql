...
CREATE TABLE "tournaments" (
  ...
  "tier" character varying NOT NULL DEFAULT 'C Tier',
  "created_at" timestamptz NOT NULL,
  "updated_at" timestamptz NOT NULL,
...
CREATE TABLE "notifications" (
  ...
  "title" character varying NOT NULL,
  "message" character varying NULL,
  "href" character varying NULL,
  "read" boolean NOT NULL DEFAULT false,
  "read_at" timestamptz NULL,
  "user_notifications" bigint NOT NULL,
  PRIMARY KEY ("id"),
...
-- Create index "notification_read" to table: "notifications"
CREATE INDEX "notification_read" ON "notifications" ("read");
-- Create index "notification_user_notifications" to table: "notifications"
CREATE INDEX "notification_user_notifications" ON "notifications" ("user_notifications");
-- Create "team_members" table
CREATE TABLE "team_members" (
  "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  "role" character varying NOT NULL,
  "can_receive_team_elo" boolean NOT NULL DEFAULT true,
