...
-- Create index "invitation_invitation_invitee" to table: "invitations"
CREATE UNIQUE INDEX "invitation_invitation_invitee" ON "invitations" ("invitation_invitee");
...
CREATE TABLE "team_members" (
  ...
  CONSTRAINT "team_members_tournaments_tournament" FOREIGN KEY ("team_member_tournament") REFERENCES "tournaments" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
-- Create index "tournamentadmin_tournament_admin_tournament" to table: "tournament_admins"
CREATE UNIQUE INDEX "tournamentadmin_tournament_admin_tournament" ON "tournament_admins" ("tournament_admin_tournament");
...
CREATE TABLE "user_votes" (
  ...
  CONSTRAINT "user_votes_users_user" FOREIGN KEY ("user_vote_user") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
-- Create index "uservote_user_vote_component" to table: "user_votes"
CREATE UNIQUE INDEX "uservote_user_vote_component" ON "user_votes" ("user_vote_component");
